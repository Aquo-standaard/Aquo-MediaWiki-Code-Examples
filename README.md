...
De URL die je hebt gegeven is een verzoek aan een MediaWiki API, waarschijnlijk met de Semantic MediaWiki extensie of een vergelijkbare geavanceerde zoekextensie. Het lijkt een verzoek te zijn voor een speciale pagina, waarschijnlijk 'Speciaal:Vragen' (Special:Ask), die wordt gebruikt om semantische zoekopdrachten uit te voeren. Hier is een ontleding van de URL en de componenten:
